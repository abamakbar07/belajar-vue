<template>
  ...
  <div class="button">
    ...
    <button @click="togleFilterFav">Filter Fav</button>: {{filter ? "Favorite book" : "All"}}
  </div>
  <span v-bind:title="message" v-if="showBook">
    ...
    <ul class="list-book">
        <li v-for="(book, i) in filter ? filteredBooks : books" v-bind:key="i" v-bind:class="{ fav: book.fav}" @click="togleFav(i)">
